const CarreraDeportiva = () => {
    return (
      ...
      <div className="mt-12 px-4 mx-auto">
        ...
        <img src="/medalla.jpg" alt="medalla" className="w-1/2 sm:w-64 md:w-80 lg:w-96 h-auto" />
        </div>

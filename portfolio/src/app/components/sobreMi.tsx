const SobreMi = () => {
    return (
      <div className="mt-12 px-4 mx-auto">
        <h1 className="text-4xl text-center font-bold">Daniel Ferrer Robles – Desarrollador Web y Nadador Paralímpico
        </h1>
      <div className="flex justify-center mb-6">
      <img src="/dani.jpg" alt="dani" className="w-62 h-50"/>
      </div>
        ...
        <div>
          <img src="/programacion.webp" alt="cod" className="h-100 object-cover mx-auto mt-7"/>
        </div>
        </div>
